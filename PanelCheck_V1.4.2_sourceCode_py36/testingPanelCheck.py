...
class TestPanelCheck(unittest.TestCase):
    ...
    def testManhattanCalc6PCs1a(self):
        ...
        scores, loadings, e_variable_variances = Manhattan_Plot.ManhattanCalc(
            data, PCs=6, standardize=False)

        self.failUnlessEqual(
            e_variable_variances.shape,
            res.shape,
            'wrong shape')
