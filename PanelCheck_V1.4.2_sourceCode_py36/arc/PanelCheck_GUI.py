    ...
    def _init_ctrls(self, prnt):
        wx.Frame.__init__(
            self, id=wx.NewId(), name=u'Main_Frame', parent=prnt, pos=wx.Point(
                ...
                8705, 5060), style=wx.CLOSE_BOX, title='PanelCheck V1.4.2')
        self._init_utils()
        ...
        self.choice_label = wx.StaticText(
            id=wx.NewId(),
            label=u'Enable/Disable every:', name='choice_label',
            parent=self.main_notebook, pos=wx.Point(600, -14),
            size=wx.Size(125, 16),
        ...
        self.choice = wx.Choice(
            choices=["Single-select", " 1st", " 2nd",
                     " 3rd", " 4th", " 5th", " 6th",
                     " 7th", " 8th", " 9th", " 10th"],
            id=wx.NewId(),
            name='choice', parent=self.main_notebook,
            pos=wx.Point(740, -16),
            size=wx.Size(100, 24),
            style=wx.TAB_TRAVERSAL)
        ...
        self.profile_radioBoxModel = wx.RadioBox(
            choices=["Increasing intensity", "Original sample order"],
            id=-1, label="Sorting:", parent=self.profile_panel,
            size=wx.DefaultSize, style=wx.RA_SPECIFY_COLS)
        ...
        self.tuck1_radioBoxModel = wx.RadioBox(
            choices=["Sample averages", "Sample replicates"],
        ...
        self.manh_spin_txt = wx.TextCtrl(
            self.manh_panel, 0, size=(50, 25),
            value="6", style=wx.TE_READONLY)
...
# dlg.Destroy()
    ...
    def OnClosing(self, event):
        ...
        self.session_data.update(
            view=v, image_save_path=self.image_save_path,
    ...
    def create_plot(self, pydata, tab_panel):
        ...
        # ----------------------------------------------------
            ...
            if pydata[0] == "Overview Plot (assessors)":
                res = Tucker1AssOverviewPlotter(
                    self.s_data, self.tucker1_plot_data, selection,
            ...
            if self.pmse_plot_data.actives_changed(
                    activeAssessors_List, activeAttributes_List,
                    activeSamples_List):
                # print "actives changed"
                self.pmse_plot_data = ANOVA_PlotData(
                    activeAssessors_List,
        ...
        # ------------------------------------------------------------
            ...
            if pydata[0] == "Overview Plot 1":  # F & p
                res = MixModel_ANOVA_OverviewPlotter(
                    ...
                    plot_type="2way1rep", abspath=self.ProgPathAbs)
                overview_plot = True
            ...
            if pydata[0] == "Overview Plot 1":  # F & p
                res = MixModel_ANOVA_OverviewPlotter(
                    self.s_data, self.mm_anova2_plot_data, plot_type="2way",
                    abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot 2":  # LSD
                res = MixModel_ANOVA_LSD_OverviewPlotter(
            ...
            if pydata[0] == "Overview Plot 1":  # F & p
                res = MixModel_ANOVA_OverviewPlotter(
                    self.s_data, self.mm_anova3_plot_data, plot_type="3way",
                    abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot 2":  # LSD
                res = MixModel_ANOVA_LSD_OverviewPlotter(
        ...
        if plot:
            # try:
            _title = {
                "fig": "Fig. " + str(self.numberOfWindow),
                "plot": plot_title}
