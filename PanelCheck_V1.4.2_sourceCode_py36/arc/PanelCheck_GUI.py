...
#---GUI construction---#FFFFFF#FF8040-------------------------------------------
    ...
    def _init_ctrls(self, prnt):
        ...
        self.main_notebook = wx.Notebook(id=wx.NewId(),
              ...
              size=wx.Size(852, 465),
              style=wx.NB_FIXEDWIDTH | wx.TAB_TRAVERSAL|wx.STRETCH_NOT)
        ...
        self.choice_label = wx.StaticText(id=wx.NewId(), label=u'Enable/Disable every:',
              ...
              -14), size=wx.Size(125, 16), style=wx.TAB_TRAVERSAL)
        ...
        self.choice = wx.Choice(choices=["Single-select", " 1st", " 2nd", " 3rd",
              ...
              size=wx.Size(100, 24), style=wx.TAB_TRAVERSAL)
        ...
        self.profile_panel.lower_right_sizer.Add(self.profile_radioBoxModel, 0, wx.STRETCH_NOT)
        ...
        self.tuck1_radioBoxModel = wx.RadioBox(choices=["Sample averages", "Sample replicates"],
              ...
              size=wx.DefaultSize,
              style=wx.RA_SPECIFY_COLS)
        self.tuck1_panel.lower_right_sizer.Add(self.tuck1_radioBoxModel, 0, wx.STRETCH_NOT)
        self.tuck1_panel.lower_right_sizer.AddSpacer(5)
        ...
        bsizer = wx.StaticBoxSizer(box, wx.HORIZONTAL)
        self.manh_spin_txt = wx.TextCtrl(self.manh_panel, 0, size=(50, 25), value="6", style=wx.TE_READONLY)
        self.manh_spin = wx.SpinButton(self.manh_panel, 0, size=(25, 25), style=wx.SP_VERTICAL)
        ...
        self.sizer.Add(self.main_notebook, 1, wx.LEFT|wx.TOP|wx.STRETCH_NOT)
...
##        dlg.Destroy()
    ...
    def OnMenuHelpAboutMenu(self, event):
        ...
        event passed to a callback or member function.
        """
        frame = AboutFrame(None,self.ProgPathAbs)
        frame.Show()
    ...
    def initialize_variables(self):
        ...
        self.session_data = load_session_data(filename=self.ProgPathAbs + "/session.dat")
    ...
    def create_plot(self, pydata, tab_panel):
        ...
        if tab_panel == self.line_panel:
            ...
            if pydata[0] == "Overview Plot":
                ...
                res = AssessorLineOverviewPlotter(self.s_data, plot_data,self.ProgPathAbs)
                overview_plot = True
            elif len(pydata) == 3:
                res = ReplicateLinePlotter(self.s_data, plot_data,self.ProgPathAbs)
            #print pydata
            elif len(pydata) == 2:
                res = AssessorLinePlotter(self.s_data, plot_data,self.ProgPathAbs)
            #print pydata
            elif len(pydata) == 1:
                res = SampleLinePlotter(self.s_data, plot_data,self.ProgPathAbs)
            #print pydata
            else:
                print("The root!!!")
        ...
        # ----------------------------------------------------------
            ...
            if pydata[0] in self.AssessorList:
                ...
                overview_plot = True
                res = RawDataAssessorOverviewPlotter(self.s_data, self.mean_plot_data,abspath=self.ProgPathAbs)

            elif pydata[0] == "Overview Plot (attributes)":
                overview_plot = True
                res = RawDataAttributeOverviewPlotter(self.s_data, self.mean_plot_data,abspath=self.ProgPathAbs)
        ...
        # ----------------------------------------------------------
            ...
            if len(pydata) == 2:
                ...
                if pydata[1] == "Overview Plot":
                    res = CorrelationOverviewPlotter(self.s_data, plot_data,abspath=self.ProgPathAbs)
                    overview_plot = True
                else:
        ...
        # ----------------------------------------------------
            ...
            if pydata[0] == "Overview Plot (assessors)":
                res = Tucker1AssOverviewPlotter(self.s_data, self.tucker1_plot_data, selection,abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot (attributes)":
                res = Tucker1AttOverviewPlotter(self.s_data, self.tucker1_plot_data, selection,abspath=self.ProgPathAbs)
                overview_plot = True
            else:
                res = Tucker1Plotter(self.s_data, self.tucker1_plot_data, selection=selection,abspath=self.ProgPathAbs)
            ...
            if pydata[0] == "Overview Plot":
                res = profileOverviewPlotter(self.s_data, self.profile_plot_data, selection=selection,abspath=self.ProgPathAbs)
                overview_plot = True
            else:
                res = profilePlotter(self.s_data, self.profile_plot_data, selection=selection,abspath=self.ProgPathAbs)
            ...
            if pydata[0] == "Overview Plot":
                res = EggshellOverviewPlotter(self.s_data, self.egg_plot_data,abspath=self.ProgPathAbs)
                overview_plot = True
            else:
            ...
            if pydata[0] == "Overview Plot (assessors)" or pydata[0] == "Overview Plot (attributes)":
                res = pmse_OverviewPlotter(self.s_data, self.pmse_plot_data,abspath=self.ProgPathAbs)
                overview_plot = True
            else:
                res = pmsePlotter(self.s_data, self.pmse_plot_data,abspath=self.ProgPathAbs)
        ...
        # ------------------------------------------------------------
            ...
            if pydata[0] == "Overview Plot 1": # F & p
                res = MixModel_ANOVA_OverviewPlotter(self.s_data, self.mm_anova1_plot_data, plot_type="2way1rep",abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot 2": # LSD
                res = MixModel_ANOVA_LSD_OverviewPlotter(self.s_data, self.mm_anova1_plot_data, plot_type="2way1rep",abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] in _types:
                res = MixModel_ANOVA_Plotter_2way1rep(self.s_data, self.mm_anova1_plot_data,abspath=self.ProgPathAbs)
            elif pydata[0] in lsd_types:
                res = MixModel_ANOVA_LSD_Plotter_2way1rep(self.s_data, self.mm_anova1_plot_data,abspath=self.ProgPathAbs)
            ...
            if pydata[0] == "Overview Plot 1": # F & p
                res = MixModel_ANOVA_OverviewPlotter(self.s_data, self.mm_anova2_plot_data, plot_type="2way",abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot 2": # LSD
                res = MixModel_ANOVA_LSD_OverviewPlotter(self.s_data, self.mm_anova2_plot_data, plot_type="2way",abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] in _types:
                res = MixModel_ANOVA_Plotter_2way(self.s_data, self.mm_anova2_plot_data,abspath=self.ProgPathAbs )
            elif pydata[0] in lsd_types:
                res = MixModel_ANOVA_LSD_Plotter_2way(self.s_data, self.mm_anova2_plot_data,abspath=self.ProgPathAbs )
            ...
            if pydata[0] == "Overview Plot (assessors)":
                res = ManhattanAssOverviewPlotter(self.s_data, self.manh_plot_data, selection=selection,abspath=self.ProgPathAbs)
                overview_plot = True
            elif pydata[0] == "Overview Plot (attributes)":
                res = ManhattanAttOverviewPlotter(self.s_data, self.manh_plot_data, selection=selection,abspath=self.ProgPathAbs)
                overview_plot = True
            else:
                res = ManhattanPlotter(self.s_data, self.manh_plot_data, selection=selection,abspath=self.ProgPathAbs)
        ...
        if plot:
            ...
            print(self.ProgPathAbs)
            self.figureList.append(GridFrame(self, frame_name, result_list, config=grid_config,abspath=self.ProgPathAbs))
            if self.figureList[len(self.figureList)-1] != None:
                self.figureList[len(self.figureList)-1].Show()
