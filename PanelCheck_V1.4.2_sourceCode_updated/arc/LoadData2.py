...
# ---Diverse methods:---#FFFFFF#FF8040------------------------------------
    ...
    def __init__(self, parent, name):
        ...
        try:
            ...
            self.enc, self.dec = codecs.lookup(
                self.encoding3)[
            ...
            if self.isEmpty(row[i]):
                ...
                if i >= 3:
                    ...
                    if not self.isFloat(row[i]):
                        ...
                        # self.showErrorDialog_YES_NO(self.error)
                        if True:  # self.drop:
                            print("Deleting column! Not digit score-value at row-number:" + str(
                                rowNum + 1) + " column-number:" + str(i + 1))
